...
//       images: [
//         { id: "1", url: "/placeholder.svg", name: "imagen1.jpg", uploadDate: "2024-01-05" },
//         { id: "2", url: "/placeholder.svg", name: "imagen2.jpg", uploadDate: "2024-01-03" },
//         { id: "3", url: "/placeholder.svg", name: "imagen3.jpg", uploadDate: "2024-01-01" },
//       ]
//     },
//     "2": {
//       id: "2", 
...
//       images: [
//         { id: "4", url: "/placeholder.svg", name: "foto1.png", uploadDate: "2024-01-04" },
//         { id: "5", url: "/placeholder.svg", name: "foto2.png", uploadDate: "2024-01-02" },
//       ]
//     },
//   };
...
//                   <span className="text-sm text-foreground">{userData.location}</span>
//                 </div>
...
//                       <p className="font-medium text-foreground">{userData.lastActive}</p>
//                     </div>
//                   </div>
//                 </div>
//                 <div className="pt-4 border-t border-border">
//                   <p className="text-muted-foreground text-sm">Total imágenes</p>
//                   <p className="text-2xl font-bold text-primary">{allImages.length}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
